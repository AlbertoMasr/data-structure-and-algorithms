    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            try {
                ...
                switch (option) {
                    case 1 -> HashTableHandler.print(hashTable);
                    case 2 -> HashTableHandler.put(hashTable);
                    case 3 -> HashTableHandler.get(hashTable);
                    case 4 -> HashTableHandler.remove(hashTable);
